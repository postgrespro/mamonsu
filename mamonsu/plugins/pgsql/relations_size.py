    ...
    def __init__(self, config):
        ...
        if self.is_enabled():
            ...
            SELECT relation.schema,
                   relation.name,
                   CASE WHEN l.mode = 'AccessExclusiveLock' THEN '-1' ELSE (pg_total_relation_size(cl.oid)) END AS pg_total_relation_size,
                   CASE WHEN l.mode = 'AccessExclusiveLock' THEN '-1' ELSE (sum(pg_total_relation_size(inh.inhrelid))) END AS pg_total_relation_size_part
